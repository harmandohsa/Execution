...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<section class="header-video">
		<div id="hero_video">
			<div id="sub_content">
                <img src="img/Execution.jpeg" alt="" class="header-video--media" data-video-src="video/Execution" data-teaser-source="video/Execution" data-provider="" data-video-width="1920" data-video-height="960">
		...
		<div id="count" class="hidden-xs">
			<ul>
				<li><span style="width:60px; font-weight: 500; font-size: 24px;" id="spanVideos"></span> Videos</li>
				<%--<li><span style="width:60px; font-weight: 500; font-size: 24px;" id="spanVideosVistos"></span> Videos Vistos</li>--%>
				<li><span style="width:60px; font-weight: 500; font-size: 24px;" id="spanUsrRegis"></span> Usuarios Registrados</li>
                <li><span style="width:60px; font-weight: 500; font-size: 24px;" id="spanLikes"></span> Likes</li>
                <li><span style="width:60px; font-weight: 500; font-size: 24px;" id="spanComentarios"></span> Comentarios</li>
			</ul>
		</div>
	</section>
	<!-- End Header video -->
